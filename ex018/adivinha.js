// Todas as variaveis aqui em cima - fora das funções - são consideradas GLOBAIS e funcionam dentro de qualquer outra função!
...
function jogar() {
    ...
    if (jogador < computador) {
        ...
        res.innerHTML += `<p><strong>PARABENS!</strong> Você acertou! Eu tinha sorteado o valor ${computador}!</p>`
